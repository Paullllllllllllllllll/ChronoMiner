# modules/llm/payload_builder.py

"""Payload construction for Responses-API extraction requests."""
...
from modules.llm.schema_utils import (
    _build_structured_text_format,  # noqa: F401 -- re-exported for back-compat
