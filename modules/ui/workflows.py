...
class WorkflowUI:
    ...
    def display_welcome() -> None:
        ...
        print_header("CHRONO MINER", "Structured Data Extraction Tool")
        ui_print(
            "  Extract structured data from historical documents using",
            PromptStyle.INFO,
        )
    ...
    @staticmethod
    def select_schema(
        schema_options: list[tuple[str, str]], allow_back: bool = True
    ) -> str | None:
        ...
        result = prompt_select(
            "Select a schema for extraction:", schema_options, allow_back=allow_back
        )
    ...
    @staticmethod
    def select_files(
        available_files: list[Path], allow_back: bool = True
    ) -> list[Path] | None:
        ...
        result = prompt_multiselect(
            "Select files to process:", options, allow_all=True, allow_back=allow_back
        )
    ...
    @staticmethod
    def select_processing_mode(allow_back: bool = True) -> str | None:
        ...
        options = [
            ...
            (
                "batch",
                "Batch — Queue files for async processing (lower cost, longer wait)",
            ),
        ]

        result = prompt_select(
            "Select processing mode:", options, allow_back=allow_back
        )
    ...
    def get_input_path(
        ...
        """
        while True:
            result = prompt_text(prompt_message, allow_back=allow_back)
    ...
    def display_completion(
        success_count: int, total_count: int, error_count: int = 0
    ) -> None:
