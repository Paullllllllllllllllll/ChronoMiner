...
def handle_navigation_input(user_input: str, allow_back: bool = False) -> NavigationAction | None:
...
def prompt_text(
    ...
    """
    prompt_text_display = question
    if default:
        prompt_text_display = f"{question} [{default}]"
