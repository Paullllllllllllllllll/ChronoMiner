...
*Note:* Gemini models are excluded from the extraction benchmark because all three evaluation schemas exceed the Gemini structured outputs API nesting depth limit.
