...
class TestBoundaryAlreadyOnTarget:
    ...
    without marker matching and without triggering _verify_no_content."""

    @pytest.mark.asyncio
    async def test_high_certainty_keeps_original(self) -> None:
        """Route 0 fires: adjusted_range == original_range, no deletion."""
        readjuster = _make_readjuster()
        readjuster.certainty_threshold = 70
    ...
    @pytest.mark.asyncio
    async def test_low_certainty_does_not_trigger_route_0(self) -> None:
        """Below-threshold certainty bypasses Route 0, falls to retry."""
        readjuster = _make_readjuster()
        readjuster.certainty_threshold = 70
        readjuster.max_low_certainty_retries = 1
        readjuster.max_context_expansion_attempts = 0
        readjuster.max_marker_mismatch_retries = 0
    ...
    @pytest.mark.asyncio
    async def test_verify_no_content_not_called(self) -> None:
        """Route 0 must not trigger _verify_no_content."""
        readjuster = _make_readjuster()
        readjuster.certainty_threshold = 70
        ...
        readjuster._run_model = AsyncMock(return_value=payload)
        readjuster._verify_no_content = AsyncMock()
        ...
        readjuster._verify_no_content.assert_not_called()
        assert result.should_delete is False
