...
class TestResolveField:
    ...
    def test_flat_key(self):
        from modules.conversion.base import resolve_field
    ...
    def test_dotted_key(self):
        ...
        assert (
            resolve_field({"address": {"street": "Main"}}, "address.street") == "Main"
        )
    ...
    def test_dotted_key_outer_not_dict(self):
        ...
        assert (
            resolve_field({"address": "flat"}, "address.street", default="N/A") == "N/A"
        )


class TestBaseConverterHelpers:
    def _make(self, name="s"):
        from modules.conversion.base import BaseConverter

        class Impl(BaseConverter):
            def convert(self, j, o):
                pass
...
class TestFilterTextFiles:
    ...
    def test_keeps_plain_txt(self, tmp_path):
        from main.bootstrap import filter_text_files
...
class TestCollectTextFiles:
    ...
    def test_collects_from_dir(self, tmp_path):
        from main.bootstrap import collect_text_files
...
class TestValidateSchemaPaths:
    ...
    def test_valid_returns_true(self):
        ...
        assert (
            validate_schema_paths("S", {"S": {"input": "/in", "output": "/out"}})
            is True
        )
    ...
    def test_missing_output_returns_false(self):
        ...
        assert (
            validate_schema_paths("S", {"S": {"input": "/in", "output": ""}}) is False
        )
    ...
    def test_missing_input_returns_false(self):
        ...
        assert (
            validate_schema_paths("S", {"S": {"input": None, "output": "/out"}})
            is False
        )
...
class TestDetectCapabilitiesOpenRouter:
    ...
    def test_deepseek_r1_is_reasoning(self):
        ...
        assert (
            caps.is_reasoning_model is True and caps.supports_reasoning_effort is True
        )
